...
def create_hm_account(username, email, password):
    ...
    while True:
        try:
            ...
            time.sleep(.8)
            driver.find_element(By.XPATH, '//*[@id="__next"]/main/div/form/button[10]').click()
            break
        except:
            pass
        try:
    ...
    try:
        ...
        wait.until(EC.presence_of_element_located((By.XPATH, '//*[@id="__next"]/main/div/ul/li[2]/button/article/div[1]/span/img'))).click()
        time.sleep(1)
        wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="__next"]/main/div/div[3]/div/div[4]/div/a'))).click()
        offer_code_element = wait.until(EC.visibility_of_element_located((By.XPATH, "//*[@id="__next"]/main/div/div[3]/div/div[3]/label")))
        offer_code = "https://www.spotify.com/kr-ko/ppt/hm/?code=" + offer_code_element.text.replace("할인 코드 ", "")
...
for _ in range(number_of_codes_to_collect):
    ...
    print(Fore.LIGHTMAGENTA_EX + f"Spotify Gen | ID: {username} PW: {password} E-Mail: {email}")
